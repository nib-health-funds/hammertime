...
const filterStoppableDBInstances = require('../../src/rds/filterStoppableDBInstances');
const notTaggedUntouchable = require('../../src/rds/notTaggedUntouchable');

describe('stoppableInstances', () => {
  describe('filterStoppableDBInstances()', () => {
    it('returns a list of running RDS DB instances', () => {
      ...
      return filterStoppableDBInstances()
        .then((arns) => {
